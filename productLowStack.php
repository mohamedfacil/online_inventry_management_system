	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="form-row bg-secondary">
                <div class="form-group col-md-3  ">
                <select id="product_category" name="product_category" onchange="myFunction()" class="form-control">
				
				      	<option value="6"disabled selected>Category</option>
				      	<?php 
                ...
                <div class="form-group col-md-3">
                <select id="stock_status"  name="stock_status" onchange="myFunction1()" class="form-control">
                ...
                <div class="form-group col-md-1">
                    <button type="submit" id="filter"class="btn btn-primary mb-2">Filter</button>
                </div>
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					    ...
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="productImage" placeholder="Product Image" name="productImage" class="file-loading" style="width:auto;"/>
					    </div>
...
<script src="custom/js/productLowStack.js"></script>
