...
$lowStockSql = "SELECT * FROM product WHERE (quantity <= 0 AND status = 1) OR (active = 2 AND status = 1)";
...
<div class="row scale">
	...
	<div class="col-md-4">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<a href="productLowStack.php" style="text-decoration:none;color:black;">
					Low Stock
