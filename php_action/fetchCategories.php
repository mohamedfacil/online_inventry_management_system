...
$sql = "SELECT categories_id, categories_name,count, categories_active, categories_status FROM categories WHERE categories_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
    ...
    $checkbox ="<input type=\"checkbox\" value='".$categoriesId."'>";
